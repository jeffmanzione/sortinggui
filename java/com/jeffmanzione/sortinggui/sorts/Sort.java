...
/**
 * Sort Class allows for generic construction of a sort so that it can be easily
...
public abstract class Sort {
  ...
  public List<Integer> lastCompared() { return compared; }

  public List<Integer> lastSwapped() { return swapped; }
  ...
  protected void done() { isDone = true; }
