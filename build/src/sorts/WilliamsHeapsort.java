...
@SortInfo(name = "Williams' Heapsort", designer = "Williams (1964)", link = "http://en.wikipedia.org/wiki/Heapsort")
...
//		// int heapSize = 8;
//		// System.out.println((int) Math.pow(2, (int) (Math.log10(heapSize) / Math.log10(2)) - 1) - 1 + (heapSize -
