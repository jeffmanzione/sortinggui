...
public class Main extends Application {
  ...
  static {
    ...
    sorts = FXCollections.observableArrayList(BozoSort.class, StoogeSort.class, BubbleSort.class,
        CocktailSort.class, SelectionSort.class, ShakerSort.class, GnomeSort.class,
        InsertionSort.class, BinaryInsertionSort.class, CombSort.class, Shellsort.class,
        WilliamsHeapsort.class, FloydsHeapsort.class, Smoothsort.class, Quicksort.class,
        QuicksortMiddlePivot.class, QuicksortRandom.class, QuicksortBestOfThree.class,
  ...
  public void start(Stage stage) throws Exception {
    ...
    left.getSelectionModel().selectedItemProperty()
        .addListener(new ChangeListener<Class<? extends Sort>>() {
          @Override
    ...
    right.getSelectionModel().selectedItemProperty()
        .addListener(new ChangeListener<Class<? extends Sort>>() {
          @Override
          public void changed(ObservableValue<? extends Class<? extends Sort>> observable,
              Class<? extends Sort> oldValue, Class<? extends Sort> newValue) {
    ...
    Group group = new Group(left, right, sdl, sdr, go, stop, reset, spd, speed, elts, elements,
        pRand, partialRandom);
