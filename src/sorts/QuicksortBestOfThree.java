      ...
      if (pivotSelection == PivotSelection.NO) {
        try {
          ...
          if (right - left < MIN_THRESHOLD) {
            ...
            System.out.println("Candidates in [" + left + "," + right + "]: " + (pivots[0] + left)
                + "(" + this.valueOf(pivots[0] + left) + ") " + (pivots[1] + left) + "("
                + this.valueOf(pivots[1] + left) + ") " + (pivots[2] + left) + "("
      ...
      switch (pivotSelection) {
        ...
        case SECOND:
          if (this.compare(minIndex, toCompare) > 0) {
            pivot = minIndex;
            System.out.println("Selected " + pivot + "(" + this.valueOf(pivot) + ")");
